...
|--------|-----------|-------------|---------------|-----------------|---------|
| b=8 s=1024 h=16 d=64 | 0.484 | 71.0 | 0.566 | 60.7 | 1.17x |
| b=8 s=2048 h=16 d=64 | 2.042 | 67.3 | 2.058 | 66.8 | 1.01x |
| b=8 s=4096 h=16 d=64 | 8.122 | 67.7 | 8.128 | 67.6 | 1.00x |
| b=16 s=1024 h=32 d=64 | 2.071 | 66.4 | 2.101 | 65.4 | 1.01x |
| b=16 s=2048 h=32 d=64 | 8.244 | 66.7 | 8.158 | 67.4 | 0.99x |
| b=16 s=4096 h=32 d=64 | 32.449 | 67.8 | 32.657 | 67.3 | 1.01x |
| b=8 s=1024 h=16 d=128 | 1.021 | 67.3 | 1.041 | 66.0 | 1.02x |
| b=8 s=2048 h=16 d=128 | 4.009 | 68.6 | 3.863 | 71.2 | 0.96x |
| b=16 s=1024 h=32 d=128 | 4.141 | 66.4 | 3.912 | 70.3 | 0.94x |
| b=16 s=2048 h=32 d=128 | 16.057 | 68.5 | 15.196 | 72.4 | 0.95x |
| b=32 s=2048 h=32 d=64 | 16.246 | 67.7 | 16.316 | 67.4 | 1.00x |
| b=32 s=4096 h=32 d=64 | 64.649 | 68.0 | 65.011 | 67.7 | 1.01x |
| b=32 s=2048 h=32 d=128 | 32.112 | 68.5 | 30.631 | 71.8 | 0.95x |
| b=32 s=4096 h=32 d=128 | 128.003 | 68.7 | 122.055 | 72.1 | 0.95x |
| b=32 s=4096 h=64 d=128 | 256.712 | 68.5 | 244.626 | 71.9 | 0.95x |

**head_dim=64**：全面持平或略优于官方实现，峰值达 71.0 TFLOPS。

**head_dim=128**：达到官方实现的 95%，约 66-69 TFLOPS。
